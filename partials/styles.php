<style>
        ...
        *{box-sizing:border-box}
        ...
        .btn-primary{background: var(--orange); border-color: rgba(255,255,255,.16); box-shadow: 0 14px 36px rgba(0,0,0,.40)}
        .btn-primary:hover{background: rgba(245,124,0,.92); transform: translateY(-1px); box-shadow: 0 18px 46px rgba(0,0,0,.48)}
        .btn-primary:active{background: rgba(245,124,0,.86)}
        .btn-whatsapp{background: #25D366; border-color: rgba(255,255,255,.16); box-shadow: 0 14px 36px rgba(0,0,0,.40)}
        .btn-whatsapp:hover{background: rgba(37,211,102,.92); transform: translateY(-1px); box-shadow: 0 18px 46px rgba(0,0,0,.48)}
        .btn-whatsapp:active{background: rgba(37,211,102,.86)}
        ...
        .hero-card{position:relative; border-radius: var(--radius); border:1px solid rgba(255,255,255,.12); background: linear-gradient(180deg, rgba(255,255,255,.06), rgba(255,255,255,.03)); box-shadow: var(--shadow); overflow:hidden}
        .hero-card img{width:100%; height:440px; object-fit:cover; display:block; filter:saturate(1.08) contrast(1.06)}
        .overlay{position:absolute; inset:0; background: radial-gradient(600px 320px at 30% 15%, rgba(54,182,255,.20), transparent 60%), radial-gradient(600px 420px at 70% 30%, rgba(245,124,0,.16), transparent 62%), linear-gradient(180deg, rgba(11,31,51,.10), rgba(11,31,51,.78))}
        ...
        @media (max-width: 980px){
            ...
            .profile, .faq-cta .card{position:static}
        }
