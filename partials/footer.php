    ...
    <div class="container">
        <div class="footer-grid">
            <div>
                ...
                <p class="small">Soluções para computadores, notebooks e periféricos em <?= htmlspecialchars($city, ENT_QUOTES, 'UTF-8'); ?>. Atendimento direto, humanizado e transparente.</p>
